...
export const speakerPackages = [
  {
    ...
    includes: [ "Speaking slot (15-20 minutes)", "Certificate of Recognition", "Global Networking Access", "Professional Event Photos", "Featured on Website", ],
...
export const delegatePass = {
  ...
  earlyBirdPrice: "$249",
  regularPrice: "$350",
  buttonLabel: "Choose Delegate",
  includes: [ "Full Access to All Sessions", "Networking Opportunities",  "Participation Certificate", ],
};

export const earlyBirdOffer = {
  title: "Early Bird Offer",
  description: "Early Bird Offer valid for first 50 registrations only.",
  securedText: "18 slots already secured.",
  reminder: "Limited spots remaining - secure your place now.",
};

export const speakers = [
  { id: 1, image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=300&q=80",
    name: "Dr. Arjun Mehta", country: "India",  role: "Global Strategy Advisor",  },
  { id: 2, image: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=300&q=80",
    name: "Sarah Al-Rashidi", country: "UAE", role: "CEO, FuturePath Inc.", },
  { id: 3, image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&q=80",
    name: "James O'Brien", country: "United Kingdom", role: "Keynote Speaker & Author",},
  { id: 4, image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=300&q=80",
    name: "Amara Nwosu", country: "Nigeria", role: "Policy & Innovation Leader", },
];
...
export const pastConferences = [
  { id: 1, image: "https://images.unsplash.com/photo-1475721027785-f74eccf877e2?w=500&q=80",
    title: "Global Visionaries Summit",  date: "March 2024", location: "Paris, France", },
  { id: 2, image: "https://images.unsplash.com/photo-1527529482837-4698179dc6ce?w=500&q=80",
    title: "Leaders of Tomorrow Forum", date: "July 2024", location: "Mumbai, India", },
  {    id: 3, image: "https://images.unsplash.com/photo-1560523159-4a9692d222ef?w=600&q=80",
    title: "Signature CEO Roundtable", date: "October 2023", location: "New York, USA", },
  { id: 4, image: "https://images.unsplash.com/photo-1560250097-0b93528c311a?w=500&q=80",
    title: "International Impact Conference", date: "January 2023", location: "Dubai, UAE", },
  { id: 5, image: "https://images.unsplash.com/photo-1515187029135-18ee286d815b?w=500&q=80",
    title: "Women Who Lead Summit", date: "May 2023", location: "London, UK", },
  { id: 6, image: "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=500&q=80",
    title: "Innovation Nexus Conference", date: "September 2022", location: "Singapore", },
  { id: 7, image: "https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?w=500&q=80",
    title: "Entrepreneurship World Forum", date: "November 2022", location: "Toronto, Canada", },
];