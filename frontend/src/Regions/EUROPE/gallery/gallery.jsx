...
import usagallery from "../../USA/Images/usagallery.jpeg";
import usagallery0 from "../../USA/Images/usagallery8.jpeg";
import usagallery1 from "../../USA/Images/usagallery2.jpeg";
import usagallery2 from "../../USA/Images/usagallery3.jpeg";
import usagallery3 from "../../USA/Images/usagallery12.jpeg";
import usagallery4 from "../../USA/Images/usagallery5.jpeg";
import usagallery5 from "../../USA/Images/usagallery6.jpeg";
import usagallery6 from "../../USA/Images/usagallery7.jpeg";
import usagallery7 from "../../USA/Images/usagallery1.jpeg";
import usagallery8 from "../../USA/Images/usagallery9.jpeg";
import usagallery9 from "../../USA/Images/usagallery10.jpeg";
// import usagallery10 from "../Images/usagallery11.jpeg";

import newimgusa from "../../USA/Images/galleryusa.jpeg";
import newimgusa1 from "../../USA/Images/galleryusa1.jpeg";
import newimgusa2 from "../../USA/Images/galleryusa2.jpeg";
import newimgusa3 from "../../USA/Images/galleryusa3.jpeg";
import newimgusa4 from "../../USA/Images/galleryusa4.jpeg";
import newimgusa5 from "../../USA/Images/galleryusa5.jpeg";
...
function GalleryHero() {
  ...
  return (
    <section className="europe-gl-hero">
      <div className="europe-gl-hero__inner">
        <div className="europe-gl-hero__content">
          ...
          <div className="europe-gl-hero__actions">
            <button className="europe-gl-hero__cta">
              <span>Explore Gallery</span>
              <svg
                className="europe-gl-hero__cta-arrow"
                viewBox="0 0 16 16"
                fill="none"
            ...
            <div className="europe-gl-hero__stats">
              {HERO_STATS.map((stat) => (
                <div className="europe-gl-hero__stat" key={stat.label}>
        ...
        <div className="europe-gl-hero__collage" aria-hidden="true">
          {featured.map((photo, i) => (
            <div className={`europe-gl-hero__frame europe-gl-hero__frame--${i + 1}`} key={photo.url}>
              <img src={photo.url} alt={photo.alt} loading={i === 0 ? "eager" : "lazy"} />
            </div>
          ))}
          {/* <span className="europe-gl-hero__tag">Dubai · 2025</span> */}
        </div>
      </div>
    </section>
  );
    ...
    <section className="europe-hs">
      ...
      <div className="europe-hs__inner">
        <div className="europe-hs__text" key={`text-${animKey}`}>
          ...
          <h1 className="europe-hs__heading" aria-label={slide.heading.join(" ")}>
            {slide.heading.map((line, i) => (
              <span
                key={i}
                className="europe-hs__heading-line"
        ...
        <div className="europe-hs__card-area">
          ...
          <div
            className={`europe-hs__entrance europe-hs__entrance--${slide.anim}`}
    ...
    <section className="europe-rg-section">
      <div className="europe-rg-header">
        <div className="europe-rg-header__left">
          ...
          <h2 className="europe-rg-title">  Moments That <br />  <em>Move the World</em> </h2>
        </div>
